...
class OrderCreateFormTest(TestCase):
    def test_field_address_form(self):
        ...
        self.assertTrue(
            form.fields["address"].widget.__class__.__name__
            == Textarea().__class__.__name__
        )
    ...
    def test_field_city_form(self):
        ...
        self.assertTrue(
            form.fields["city"].widget.__class__.__name__
    ...
    def test_field_card_number_form(self):
        ...
        self.assertTrue(
            form.fields["card_number"].widget.__class__.__name__
            == TextInput().__class__.__name__
        )
    ...
    def test_field_delivery_type_form(self):
        form = OrderCreateForm()
        self.assertTrue(
            form.fields["delivery_type"].widget.__class__.__name__
    ...
    def test_field_payment_type_form(self):
        form = OrderCreateForm()
        self.assertTrue(
            form.fields["payment_type"].widget.__class__.__name__
            == RadioSelect().__class__.__name__
        )
