...
class SiteSettingsTest(TestCase):
    ...
    def test_category_main_page_label(self):
        ...
        self.assertEquals(
            field_label, "Категории для показа на главной странице (не больше 3)"
        )
    ...
    def test_quantity_popular_label(self):
        ...
        self.assertEquals(
            field_label, "Количество популярных товаров на главной странице"
        )
    ...
    def test_time_cache_product_label(self):
        ...
        self.assertEquals(
            field_label, "Через какое кол-во дней кэшировать данные о продукте"
        )
