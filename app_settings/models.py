...
class SiteSettings(SingletonModel):
    ...
    edge_for_free_delivery = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Порог бесплатной доставки"
    )
    ...
    quantity_popular = models.PositiveIntegerField(
        verbose_name="Количество популярных товаров на главной странице", default=8
    )
