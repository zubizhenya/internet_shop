...
class Category(MPTTModel):
    ...
    slug = models.SlugField(
        max_length=200, db_index=True, unique=True, verbose_name="Псевдоним для url"
    )
...
class Product(models.Model):
    ...
    name = models.CharField(max_length=200, db_index=True, verbose_name="Название")
    slug = models.SlugField(
        max_length=200, db_index=True, verbose_name="Псевдоним для url"
    )
    ...
    manufacturer = models.CharField(
        max_length=50, db_index=True, verbose_name="Производитель"
    )
...
class PropertyName(models.Model):
    name = models.CharField(
        max_length=255, db_index=True, verbose_name="характеристика"
    )
...
class Property(models.Model):
    ...
    product = models.ForeignKey(
        Product, on_delete=models.CASCADE, verbose_name="товар", related_name="property"
    )
