...
class UserCreateFormTest(TestCase):
    def test_field_password1_form(self):
        ...
        self.assertEqual(
            form.fields["password1"].widget.attrs["placeholder"], "Введите пароль"
        )
        self.assertEqual(
            form.fields["password1"].widget.__class__.__name__,
            PasswordInput().__class__.__name__,
        )
    ...
    def test_field_full_name_form(self):
        ...
        self.assertEqual(
            form.fields["full_name"].widget.attrs["placeholder"], "Введите ФИО"
        )
        self.assertEqual(
            form.fields["full_name"].widget.__class__.__name__,
            TextInput().__class__.__name__,
        )
    ...
    def test_field_email_form(self):
        ...
        self.assertEqual(
            form.fields["email"].widget.__class__.__name__,
            TextInput().__class__.__name__,
        )
    ...
    def test_field_phoneNumber_form(self):
        ...
        self.assertEqual(
            form.fields["phoneNumber"].widget.__class__.__name__,
            TextInput().__class__.__name__,
        )
    ...
    def test_field_avatar_form(self):
        ...
        self.assertEqual(
            form.fields["avatar"].widget.__class__.__name__,
...
class UserLoginFormTest(TestCase):
    def test_field_password1_form(self):
        ...
        self.assertEqual(
            form.fields["username"].widget.attrs["placeholder"], "Введите e-mail"
        )
        self.assertEqual(
            form.fields["username"].widget.__class__.__name__,
            TextInput().__class__.__name__,
        )
    ...
    def test_field_password_form(self):
        ...
        self.assertEqual(
            form.fields["password"].widget.attrs["placeholder"], "Введите пароль"
        )
        self.assertEqual(
...
class MySetPasswordFormTest(TestCase):
    ...
    def test_field_password1_form(self):
        ...
        self.assertEqual(
            form.fields["new_password1"].widget.attrs["placeholder"], "Введите пароль"
        )
        self.assertEqual(
            form.fields["new_password1"].widget.__class__.__name__,
            PasswordInput().__class__.__name__,
        )
    ...
    def test_field_password2_form(self):
        ...
        self.assertEqual(
            form.fields["new_password2"].widget.__class__.__name__,
            PasswordInput().__class__.__name__,
        )
